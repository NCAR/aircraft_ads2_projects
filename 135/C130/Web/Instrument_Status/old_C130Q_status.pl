...
<table>
@{[status_input('19',' Airborne Data System (ADS)')]}
@{[status_input('20',' ADS Operator Station')]}
...
@{[status_input('25',' Flight Deck Display')]}
@{[status_input('26',' Honeywell HG1095-AC03 (IRS)')]}
@{[status_input('27',' Garmin GPS16 (GPS)')]}
@{[status_input('28',' CMIGETS (INS)')]}
@{[status_input('29',' Rosemount 1501 Static pressure (PSFDC)')]}
@{[status_input('30',' Ruska 7885 Static pressure (PSFC)')]}
@{[status_input('31',' Rosemount 1201F1 Cabin pressure (PCAB)')]}
@{[status_input('32',' Rosemount 1221F1VL Dynamic pressure (QCRC)')]}
@{[status_input('33',' Rosemount 1221F1VL Dynamic pressure (QCFC)')]}
@{[status_input('34',' Rosemount 1221F1VL Dynamic pressure (QCFRC)')]}
@{[status_input('35',' Rosemount temperature (ATRR)')]}
@{[status_input('36',' Rosemount temperature (ATRL)')]}
@{[status_input('37',' Rosemount deiced temperature (ATWH)')]}
@{[status_input('38',' Ophir temperature (OAT)')]}
@{[status_input('39',' Rosemount 1221F1VL Attack (ADIFR)')]}
@{[status_input('40',' Rosemount 1221F1VL Sideslip (BDIFR)')]}
@{[status_input('41',' General Eastern 1011B Dewpoint temperature (DPT)')]}
@{[status_input('42',' General Eastern 1011B Dewpoint temperature (DPB)')]}
@{[status_input('43',' SpectraSensors TDL (MRLH)')]}
@{[status_input('44',' CrossFlow Lyman-alpha (MRLA)')]}
@{[status_input('45',' Crossflow Lyman-alpha (MRLA1)')]}
@{[status_input('46',' Eppley PSP Pyranometer top (SWTC)')]}
@{[status_input('47',' Eppley PSP Pyranometer bottom (SWB)')]}
@{[status_input('48',' Eppley TUVR Ultraviolet top (UVT)')]}
@{[status_input('49',' Eppley TUVR Ultraviolet bottom (UVB)')]}
@{[status_input('50',' Eppley PIR Pyrgeometer top (IRTC)')]}
@{[status_input('51',' Eppley PIR Pyrgeometer bottom (IRBC)')]}
@{[status_input('52',' Heiman KT19.85 Remote surface temperature (RSTB)')]}
@{[status_input('53',' Heiman KT19.85 Remote surface temperature (RSTB1)')]}
@{[status_input('54',' Heiman KT19.85 Remote sky/cloud temperature (RSTT)')]}
@{[status_input('55',' Rosemount 871FA Icing rate (RICE)')]}
@{[status_input('56',' PMS/King LWC (PLWCC)')]}
@{[status_input('57',' PMS/King LWC (PLWCC1)')]}
@{[status_input('60',' TSI 3760 CN Counter (CONCN)')]}
@{[status_input('61',' PMS SPP-200')]}
@{[status_input('62',' PMS SPP-100')]}
@{[status_input('63',' PMS 2D-C')]}
@{[status_input('64',' PMS 2D-P')]}
@{[status_input('65',' PMS 260X')]}
@{[status_input('66',' Gerber PVM-100 LWP (XGLWC)')]}
@{[status_input('67',' SPEC 2D-S Dual Particle Imager')]}
@{[status_input('68',' SPEC Cloud Particle Imager (CPI)')]}
@{[status_input('69',' Brenguier Fast FSSP')]}
@{[status_input('70',' CIRPAS Cloud Droplet Analyzer')]}
@{[status_input('71',' Radar altimeter (HGM232)')]}
@{[status_input('72',' Video cameras (forward, left, down)')]}
@{[status_input('73',' TECO Ozone Analyzer (TEO3C)')]}
@{[status_input('74',' RAF Fast-Response Ozone Analyzer (O3FSC)')]}
@{[status_input('75',' Scanning Aerosol Backscatter Lidar (SABL)')]}
@{[status_input('76',' TD GPS Dropsonde System')]}
@{[status_input('77',' Radial Differential Mobility Analyzer (RDMA)')]}
@{[status_input('78',' Wet/Dry Nephelometers')]}
@{[status_input('79',' RAF Counter-flow Virtual Impactor (CVI)')]}
@{[status_input('80',' CSIRO/RAF Giant Aerosol Impactor')]}
@{[status_input('81',' Hudson CCN')]}
@{[status_input('82',' Bandy SO2')]}
@{[status_input('83',' Bandy DMS')]}
@{[status_input('84',' Heikes In-Situ Peroxides')]}
@{[status_input('85',' Anderson Filter Pack')]}
@{[status_input('86',' U Hawaii Total Air Sampler')]}
@{[status_input('87',' Gerber Cloud-Integrating Nephelometer')]}
@{[status_input('88',' PH Meter')]}
@{[status_input('89',' CSIRO Wet/Dry Bulb Temperature')]}
</table>
<hr>
...
<dl>
 ...
 <br>
 <table>
@{[status_output('19',' Airborne Data System (ADS)')]}
@{[status_output('20',' ADS Operator Station')]}
...
@{[status_output('25',' Flight Deck Display')]}
@{[status_output('26',' Honeywell HG1095-AC03 (IRS)')]}
@{[status_output('27',' Garmin GPS16 (GPS)')]}
@{[status_output('28',' CMIGETS (INS)')]}
@{[status_output('29',' Rosemount 1501 Static pressure (PSFDC)')]}
@{[status_output('30',' Ruska 7885 Static pressure (PSFC)')]}
@{[status_output('31',' Rosemount 1201F1 Cabin pressure (PCAB)')]}
@{[status_output('32',' Rosemount 1221F1VL Dynamic pressure (QCRC)')]}
@{[status_output('33',' Rosemount 1221F1VL Dynamic pressure (QCFC)')]}
@{[status_output('34',' Rosemount 1221F1VL Dynamic pressure (QCFRC)')]}
@{[status_output('35',' Rosemount temperature (ATRR)')]}
@{[status_output('36',' Rosemount temperature (ATRL)')]}
@{[status_output('37',' Rosemount deiced temperature (ATWH)')]}
@{[status_output('38',' Ophir temperature (OAT)')]}
@{[status_output('39',' Rosemount 1221F1VL Attack (ADIFR)')]}
@{[status_output('40',' Rosemount 1221F1VL Sideslip (BDIFR)')]}
@{[status_output('41',' General Eastern 1011B Dewpoint temperature (DPT)')]}
@{[status_output('42',' General Eastern 1011B Dewpoint temperature (DPB)')]}
@{[status_output('43',' SpectraSensors TDL (MRLH)')]}
@{[status_output('44',' CrossFlow Lyman-alpha (MRLA)')]}
@{[status_output('45',' Crossflow Lyman-alpha (MRLA1)')]}
@{[status_output('46',' Eppley PSP Pyranometer top (SWTC)')]}
@{[status_output('47',' Eppley PSP Pyranometer bottom (SWB)')]}
@{[status_output('48',' Eppley TUVR Ultraviolet top (UVT)')]}
@{[status_output('49',' Eppley TUVR Ultraviolet bottom (UVB)')]}
@{[status_output('50',' Eppley PIR Pyrgeometer top (IRTC)')]}
@{[status_output('51',' Eppley PIR Pyrgeometer bottom (IRBC)')]}
@{[status_output('52',' Heiman KT19.85 Remote surface temperature (RSTB)')]}
@{[status_output('53',' Heiman KT19.85 Remote surface temperature (RSTB1)')]}
@{[status_output('54',' Heiman KT19.85 Remote sky/cloud temperature (RSTT)')]}
@{[status_output('55',' Rosemount 871FA Icing rate (RICE)')]}
@{[status_output('56',' PMS/King LWC (PLWCC)')]}
@{[status_output('57',' PMS/King LWC (PLWCC1)')]}
@{[status_output('60',' TSI 3760 CN Counter (CONCN)')]}
@{[status_output('61',' PMS SPP-200')]}
@{[status_output('62',' PMS SPP-100')]}
@{[status_output('63',' PMS 2D-C')]}
@{[status_output('64',' PMS 2D-P')]}
@{[status_output('65',' PMS 260X')]}
@{[status_output('66',' Gerber PVM-100 LWP (XGLWC)')]}
@{[status_output('67',' SPEC 2D-S Dual Particle Imager')]}
@{[status_output('68',' SPEC Cloud Particle Imager (CPI)')]}
@{[status_output('69',' Brenguier Fast FSSP')]}
@{[status_output('70',' CIRPAS Cloud Droplet Analyzer')]}
@{[status_output('71',' Radar altimeter (HGM232)')]}
@{[status_output('72',' Video cameras (forward, left, down)')]}
@{[status_output('73',' TECO Ozone Analyzer (TEO3C)')]}
@{[status_output('74',' RAF Fast-Response Ozone Analyzer (O3FSC)')]}
@{[status_output('75',' Scanning Aerosol Backscatter Lidar (SABL)')]}
@{[status_output('76',' TD GPS Dropsonde System')]}
@{[status_output('77',' Radial Differential Mobility Analyzer (RDMA)')]}
@{[status_output('78',' Wet/Dry Nephelometers')]}
@{[status_output('79',' RAF Counter-flow Virtual Impactor (CVI)')]}
@{[status_output('80',' CSIRO/RAF Giant Aerosol Impactor')]}
@{[status_output('81',' Hudson CCN')]}
@{[status_output('82',' Bandy SO2')]}
@{[status_output('83',' Bandy DMS')]}
@{[status_output('84',' Heikes In-Situ Peroxides')]}
@{[status_output('85',' Anderson Filter Pack')]}
@{[status_output('86',' U Hawaii Total Air Sampler')]}
@{[status_output('87',' Gerber Cloud-Integrating Nephelometer')]}
@{[status_output('88',' PH Meter')]}
@{[status_output('89',' CSIRO Wet/Dry Bulb Temperature')]}
 </table>
</dl>
