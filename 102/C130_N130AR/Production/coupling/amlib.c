...
VARTBL	*varp;		/* Information about current variable	*/
{
	NR_TYPE	plwcc, plwcf_lpi, hgm232;
	...
	if (first_time)
		...
		inVarID[1] = ncvarid(InputFile, "PLWCF_LPI");
		inVarID[2] = ncvarid(InputFile, "HGM232");
	...
	mindex[0] = CurrentInputRecordNumber;
	ncvarget1(InputFile, inVarID[0], mindex, (void *)&plwcc);
	ncvarget1(InputFile, inVarID[1], mindex, (void *)&plwcf_lpi);
	ncvarget1(InputFile, inVarID[2], mindex, (void *)&hgm232);
	...
	corc1 = corc1 + 0.004*( plwcf_lpi - xlwcc );
...
VARTBL	*varp;		/* Information about current variable	*/
{
	NR_TYPE	plwcc1, plwcf_lpi, hgm232;
	...
	corc2 = corc2 + 0.004*( plwcf_lpi - xlwcc1 );
...
VARTBL	*varp;		/* Information about current variable	*/
{
	NR_TYPE	xglwc, plwcf_lpi, hgm232;
	...
	corc3 = corc3 + 0.004*( plwcf_lpi - xgerb );
...
VARTBL	*varp;		/* Information about current variable	*/
{
	...
	*/
	...
	xtsurf = rstb1 * (1.00 + hgm232 * (8.892e-05 + hgm232 * (-6.0674e-09  - 
		hgm232 * 7.1807e-14)));
