...
*/
	...
	if( hr == 2 ) { 
	   if( (t >= 1240) && (t <= 3240) ){ teo3c = -32767.0; }
	}

	if( hr == 3 ){
	   if( (t >= 3308) && (t <= 3380) ||
	   	(t >= 3569) && (t <= 3595) ){ teo3c = -32767.0; }
	}
	...
	if( hr == 9 ){
	   if( (t == 3236) || (t == 3242) ){ teo3c = -32767.0; }
	}

	if( hr == 11 ){
	   if( (t >= 2580) && (t <= 2910) ){ teo3c = -32767.0; }
	}
