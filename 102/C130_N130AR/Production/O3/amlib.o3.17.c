...
*/
	...
	if( hr == 3 ) { 
	   if( t <= 3000) { teo3c = -32767.0; }
	}

	if( hr == 4 ){
	   if( (t >= 2760) && (t <= 3000) ){ teo3c = -32767.0; }
	}
	...
	if( hr == 5 ){
	   if( (t >= 1618) ||
	   	...
	   	(t >= 1632) ||
	   	(t >= 3426) && (t <= 3431) ||
	   	(t >= 3486) && (t <= 3491) ){ teo3c = -32767.0; }
	}

	if( hr == 6 ){
	   if( (t >= 40) && (t <= 65) ||
	   	(t >= 346) && (t <= 354) ){ teo3c = -32767.0; }
	}
