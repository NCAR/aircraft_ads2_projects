...
*/
	...
	if( hr == 3 ) {
	   if( (t >= 1800) && (t <= 3420) ){ teo3c = -32767.0; }
	}

	if( hr == 5 ){
	   if( (t >= 2160) && (t <= 2520) ){ teo3c = -32767.0; }
	}

	if( hr == 6 ){
	   if( (t >= 720) && (t <= 1080) ||
		(t >= 2400) && (t <= 3240) ){ teo3c = -32767.0; }
	}

	if( hr == 7 ){
	   if( (t == 1679) ||
	   	(t == 1837) ||
	   	(t >= 3300) && (t <= 3600) ){ teo3c = -32767.0; }
	}
	...
	if( hr == 11 ){
	   if( (t >= 2040) && (t <= 2520) ||
	   	...
	   	(t >= 3319) && (t <= 3329) ||
		(t >= 3420) && (t <= 3446) ||
		(t >= 3480) && (t <= 3490) ){ teo3c = -32767.0; }
	}

	if( hr == 12 ){
	   if( (t >= 900) ){ teo3c = -32767.0; }
	}
