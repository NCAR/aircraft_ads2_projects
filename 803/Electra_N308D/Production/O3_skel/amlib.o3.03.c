...
*/
	...
	if( hr == 7 ){
		if( (min == 5) && (sec == 51 || sec == 52 ) ){
			teo3c = -32767.0;
		}
		if( (min == 32) && (sec == 14 || sec == 15 ) ){
			teo3c = -32767.0;
		}
	}
	if( hr == 8 ){
		if( (min == 58) && (sec == 9 || sec == 10 ) ){
			teo3c = -32767.0;
		}
		if( (min == 59) && (sec == 44 || sec == 45 ) ){
			teo3c = -32767.0;
		}
	}
	if( hr == 9 ){
		if( (min == 0) && (sec == 7 || sec == 8 ) ){
			teo3c = -32767.0;
		}
		if( (min == 1) && (sec == 28 || sec == 29 ) ){
			teo3c = -32767.0;
		}
		if( (min == 31) && (sec >= 10 || sec <= 40 ) ){
			teo3c = -32767.0;
		}
	}
