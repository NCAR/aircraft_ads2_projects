...
*/
	...
	if( hr == 12 ){
		if( min == 0 ){
			if( sec <= 10 ){ teo3c = -32767.0; }
			if( sec >= 50 ){ teo3c = -32767.0; }
		}
		if( (min == 1) && (sec <= 0) ){ teo3c = -32767.0; }
		if( min == 22 ){
			if( (sec >= 10) && (sec <= 20) ){ teo3c = -32767.0; }
		}
		if( min == 27 ){
			if( (sec >= 21) && (sec <= 30) ){ teo3c = -32767.0; }
		}
	}

	if( hr == 14 ){
		if( (min == 40) && (sec >= 40) ){ teo3c = -32767.0; }
		if( (min == 41) && (sec <= 2) ){ teo3c = -32767.0; }
	}

	if( hr == 15 ){
		if( min == 7 ){
			if( (sec >= 35) && (sec <= 36) ){ teo3c = -32767.0; }
		}
	}
	if( hr == 16 ){
		if( min == 32 ){
			if( (sec >= 10) && (sec <= 11) ){ teo3c = -32767.0; }
		}
		if( min == 39 ){
			if( (sec >= 1) && (sec <= 11) ){ teo3c = -32767.0; }
		}
	}
