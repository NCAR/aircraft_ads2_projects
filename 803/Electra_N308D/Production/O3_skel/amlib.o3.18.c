...
*/
	...
	if( hr == 14 ){
		if( min == 6 ){
			if( (sec == 19) || (sec == 20) ){ teo3c = -32767.0; }
		}
		if( min == 7 ){
			if( (sec == 17) || (sec == 18) ){ teo3c = -32767.0; }
		}
		if( min == 8 ){
			if( (sec == 47) || (sec == 48) ){ teo3c = -32767.0; }
		}
		if( min == 8 ){
			if( (sec == 55) || (sec == 56) ){ teo3c = -32767.0; }
		}
	}

	if( hr == 15 ){
		if( min == 32 ){
			if( (sec == 53) || (sec == 54) ){ teo3c = -32767.0; }
		}
	}
	if( hr == 16 ){
		if( min == 55 ){
			if( (sec == 40) || (sec == 41) ){ teo3c = -32767.0; }
		}
	}
	if( hr == 17 ){
		if( min == 23 ){
			if( (sec == 21) || (sec == 26) ){ teo3c = -32767.0; }
		}
		if( min == 49 ){
			if( (sec == 12) || (sec == 13) ){ teo3c = -32767.0; }
		}
	}
