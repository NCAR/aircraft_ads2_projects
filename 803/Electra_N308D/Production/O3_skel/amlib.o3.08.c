...
*/
	...
	float		hr,min,sec,teo3,inteo3,p,t;
	...
	if (first_time)
		...
		inVarID[6] = ncvarid(InputFile, "PSFDC");
		inVarID[7] = ncvarid(InputFile, "TET");
	...
	ncvarget1(InputFile, inVarID[7], mindex, (void *)&t);
