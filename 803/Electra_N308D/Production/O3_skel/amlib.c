...
*/
	...
	float		hr,min,sec,teo3,inteo3,t,p;
	...
	if (first_time)
		...
		inVarID[5] = ncvarid(InputFile, "INTEO3");
		inVarID[6] = ncvarid(InputFile, "TET");
		inVarID[7] = ncvarid(InputFile, "PSFDC");
	...
	ncvarget1(InputFile, inVarID[5], mindex, (void *)&inteo3);
	ncvarget1(InputFile, inVarID[6], mindex, (void *)&t);
	ncvarget1(InputFile, inVarID[7], mindex, (void *)&p);
