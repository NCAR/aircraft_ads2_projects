...
*/
	...
	if (first_time)
		...
		inVarID[4] = ncvarid(InputFile, "INTEO3");
		inVarID[5] = ncvarid(InputFile, "PSFDC");
		inVarID[6] = ncvarid(InputFile, "TET");
	...
	ncvarget1(InputFile, inVarID[5], mindex, (void *)&p);
	ncvarget1(InputFile, inVarID[6], mindex, (void *)&tet);


	p -= 20;
	teo3c = teo3*1013/p*(273.15+tet)/273.15;
	if( hr == 13 && min >= 45 ){ teo3c = -32767.0; }
