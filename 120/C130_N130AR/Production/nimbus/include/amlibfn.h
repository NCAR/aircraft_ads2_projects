...
struct _dnfn deriveftns[] =
		...
		"COCAL",	NULL,		NULL,		szero,
		"COCOR",	NULL,		NULL,		szero,
		...
		"DPTC",		NULL,		NULL,		sdpc,
		"DPXC",		NULL,		NULL,		sdpxc,
		"DVALU",	NULL,		NULL,		sdvalue,
		...
		"XNOCAL",	NULL,		NULL,		szero,
		"XNOCOR",	NULL,		NULL,		szero,
		"XNOM",		kokInit,	NULL,		sxnom,
		"XNOYCAL",	NULL,		NULL,		szero,
		"XNOYCOR",	NULL,		NULL,		szero,
		"XNOYM",	kokInit,	NULL,		sxnoym,
		"XNOYZRO",	NULL,		NULL,		szero,
		"XNOZRO",	NULL,		NULL,		szero,
		"XO3FDG",	kokInit,	NULL,		sxo3fdg,
		"XRHCV",	NULL,		NULL,		srhcv,
		"XRLWCC",	xrlwccInit,	NULL,		sxrlwcc,
		"XSO2SCAL",	NULL,		NULL,		szero,
		"XSO2SCOR",	NULL,		NULL,		szero,
		"XSO2SZRO",	NULL,		NULL,		szero,
