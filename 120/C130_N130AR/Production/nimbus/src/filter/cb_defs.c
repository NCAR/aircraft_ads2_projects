...
void CreateEditDefaultsWindow()
{
	...
	edFrame = XmCreateFrame(EditDefaultsWindow, "edFrame", args, n);
	...
	n = 0;
	b[0] = XmCreatePushButton(edRC, "dismissButton", args, n);
	XtAddCallback(b[0], XmNactivateCallback, DismissDefaultsWindow, NULL);

	n = 0;
	b[1] = XmCreatePushButton(edRC, "resetButton", args, n);
	XtAddCallback(b[1], XmNactivateCallback, ResetDefaults, NULL);
	XtManageChildren(b, 2);


	n = 0;
	XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET); n++;
	XtSetArg(args[n], XmNtopWidget, edFrame); n++;
	XtSetArg(args[n], XmNleftAttachment, XmATTACH_FORM); n++;
	XtSetArg(args[n], XmNrightAttachment, XmATTACH_FORM); n++;
