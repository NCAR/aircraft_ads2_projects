...
*/
	...
	derived[SearchTable((char **)derived, nderive, "ONE")]->Output = FALSE;
	derived[SearchTable((char **)derived, nderive, "ZERO")]->Output = FALSE;
...
static void initSDI(char vn[])
{
	 ...
	 * PSFD1 and PSFD2.  PSFD is placed into the DERTBL, with dependencies of
	 * PSFD1 & PSFD2.  CJW - 8/94
	 */
